...
\[\exmu{\alt{\m}{n}}{g(\XX{t_1},\dots,\XX{t_{k-1}})|\XX{0}=z} \ra \exmu{\alt{\m}}{g(\XX{t_1},\dots,\XX{t_{k-1}})|\XX{0}=z}\]
...
\begin{align}
\exmu{\alt{\m}{n}}{f(\XX{0},\XX{t_2},\dots,\XX{t_k})|\XX{0} = z}&= \exmu{\alt{\m}{n}}{f_1(\XX{0})f_2(\XX{t_2},\dots,\XX{t_{k}})|\XX{0}=z}\nonumber\\
&= f_1(z)\exmu{\alt{\m}{n}}{f_2(\XX{t_2},\dots,\XX{t_{k}})|\XX{0}=z}\nonumber\\
&\os{\te{Induction}}{\ra} f_1(z)\exmu{\alt{\m}}{f_2(\XX{t_2},\dots,\XX{t_{k}})|\XX{0}=z}\nonumber\\
&= \exmu{\alt{\m}}{f(\XX{0},\XX{t_2},\dots,\XX{t_k})|\XX{0}=z}
...
\begin{align*}
\exmu{\alt{\m}{n}}{f(\XX{0},\XX{t_2},\dots,\XX{t_k})} &= \exmu{\alt{\mm}{n}}{\exmu{\alt{\m}{n}}{f(\XX{0},\XX{t_2},\dots,\XX{t_k})|\XX{0}}}\\
&\ra \exmu{\alt{\mm}}{\exmu{\alt{\m}}{f(\XX{0},\XX{t_2},\dots,\XX{t_k})|\XX{0}}}\\
&= \exmu{\alt{\m}}{f(\XX{0},\XX{t_2},\dots,\XX{t_k})}
\end{align*}

then,

\begin{align*}
\exmu{\alt{\m}{n}}{f(\XX{t_1},\dots,\XX{t_k})|\XX{0}=z}&=\exmu{\XX\sim\alt{\m}{n}}{\exmu{Y\sim \alt{\m}{n}}{f(Y_{t_1},\dots,Y_{t_k})|Y_{t_1}=\XX{t_1},Y_0=z}|\XX{0}=z}\\
&=\exmu{\XX\sim\alt{\m}{n}}{\exmu{Y\sim \alt{\m}{n}}{f(Y_{0},\dots,Y_{t_k-t_1})|Y_{0}=\XX{t_1}}|\XX{0}=z}\\
&\os{\te{Eqn \eqref{sec::Infin:eqn::zerocase}}}{\ra} \exmu{\XX\sim\alt{\m}{n}}{\exmu{Y\sim \alt{\m}}{f(Y_{0},\dots,Y_{t_k-t_1})|Y_{0}=\XX{t_1}}|\XX{0}=z}\\
&\os{\te{Theorem \ref{sec::Infin:Thm::TrotterKurtz}}}{\ra} \exmu{\XX\sim\alt{\m}}{\exmu{Y\sim \alt{\m}}{f(Y_{0},\dots,Y_{t_k-t_1})|Y_{0}=\XX{t_1}}|\XX{0}=z}\\
&=\exmu{\alt{\m}}{f(\XX{t_1},\dots,\XX{t_k})|\XX{0}=z}
\end{align*}

\begin{align*}
\exmu{\alt{\m}{n}}{f(\XX{t_1},\dots,\XX{t_k})}&= \exmu{Y\sim \XX{t_1}}{\exmu{\alt{\m}{n}}{f(\XX{t_1},\dots,\XX{t_k})|\XX{t_1}=Y}}\\
&=\exmu{Y\sim \alt{\m}{n}|_{t_1}}{\exmu{\alt{\m}{n}}{f(\XX{0},\XX{t_2-t_1},\dots,\XX{t_k-t_1})|\XX{0}=Y}}\\
&\os{\te{Eqn \eqref{sec::Infin:eqn::zerocase}}}{\ra} \exmu{Y\sim \alt{\m}{n}|_{t_1}}{\exmu{\m}{f(\XX{0},\XX{t_2-t_1},\dots,\XX{t_k-t_1})|\XX{0}=Y}}\\
&\os{\te{Theorem \ref{sec::Infin:Thm::TrotterKurtz}}}{\ra} \exmu{Y\sim \alt{\m}|_{t_1}}{\exmu{\m}{f(\XX{0},\XX{t_2-t_1},\dots,\XX{t_k-t_1})|\XX{0}=Y}}\\
&=\exmu{\alt{\m}}{f(\XX{t_1},\dots,\XX{t_k})}
\end{align*}
...
\[\alt{\m}((t_n,k_n),(t_i,k_i)_{i=1}^{n-1},z) = \m\left((\rt{i},\mark{i}) = (t_i,k_i)\te{ for } i=1,\dots,n, \XX = z\right)\]
...
\begin{equation}
L_t:= \frac{d\pr^2_t}{d\pr^1_t}(\rp) = \frac{d\mm^2}{d\mm^1}\left(\prod_{0<\rt^i\leq t} \m(\rt^i,\mark^i)\right)\exp\left(-\int_{(0,t]\times \mspce}[\m(t,\mark) - 1]\rate^1(t,\mark)\,ds\,\ell(d\mark)\right)
...
\[L_t(\rp,x):=\frac{d\pr^2_{t,x}}{d\pr^1_{t,x}}(\rp) = \left(\prod_{0<\rt^i\leq t} \m(\rt^i,\mark^i;\rp,x)\right)\exp\left(-\int_{(0,t]\times\mspce} [\m(s,k;\rp,x) - 1]\rate^1(s,k;\rp,x)\,ds\,\ell(dk)\right)\]

Giving us,

\begin{align*}
\mb{E}^2\left[f(X,\rp[0,t])\right] &= \int_\spce \mb{E}^2_x[f(x,\rp[0,t])]\,d\mm^2(x)\\
&=\int_{\spce} \mb{E}^1_x[f(x,\rp[0,t])L_t(\rp,x)]\,d\mm^2(x)\\
&= \int_{\spce} \frac{d\mm^2}{d\mm^1}(x) \mb{E}^1_x[f(x,\rp[0,t])L_t(\rp,x)]\,d\mm^1(x)\\
...
\item First, if \(I\) is finite, then it suffices to prove conditional independence for \(I =\{1,2\}\). Notice that any set \(B \in \sigma(\XXX\mb{I}_{\typset_1\sqcup \typset_2})\) can be expressed as \(B = C\sqcup D\sqcup\{(\typset_1\sqcup \typset_2)^c\}\) or \(B = C\sqcup D\) where \(C\in \sigma(\XXX\mb{I}_{\typset_1})\), \(D \in \sigma(\XXX\mb{I}_{\typset_2})\), \(C \subseteq \typset_1\) and \(D \subseteq \typset_2\). Notice also that the unions defining \(B\) are disjoint unions. Let \(B = C\sqcup D\sqcup \{(\typset_1\sqcup \typset_2)^c\}\).

\begin{align*}
\mb{E}\bigg[\ex{f(\X\mb{I}_{\typset_1\sqcup \typset_2})|\XXX\mb{I}_{\typset_1\sqcup \typset_2}}&\mb{I}_B\bigg]= \ex{f(\X\mb{I}_{\typset_1\sqcup \typset_2})\mb{I}_B}\\
&= \ex{\mb{I}_Cf(\X\mb{I}_{\typset_1\sqcup \typset_2})} + \ex{\mb{I}_Df(\X\mb{I}_{\typset_1\sqcup \typset_2})} + \ex{\mb{I}_{(\typset_1\sqcup \typset_2)^c}f(\X\mb{I}_{\typset_1\sqcup \typset_2})}\\
&= \ex{\mb{I}_C f(\X\mb{I}_{\typset_1})} + \ex{\mb{I}_D f(\X\mb{I}_{\typset_2})} + \ex{\mb{I}_{(\typset_1\sqcup \typset_2)^c}f(0)}\\
&= \ex{\mb{I}_{C}\ex{f(\X\mb{I}_{\typset_1})|\XXX\mb{I}_{\typset_1}}} + \ex{\mb{I}_{D}\ex{f(\X\mb{I}_{\typset_2})|\XXX\mb{I}_{\typset_2}}} + \ex{\mb{I}_{(\typset_1\sqcup \typset_2)^c}f(0)}
\end{align*}

In particular, we can write

\begin{equation}
\ex{f(\X\mb{I}_{\typset_1\sqcup \typset_2})|\XXX\mb{I}_{\typset_1\sqcup \typset_2}} = \mb{I}_{\typset_1}\ex{f(\X\mb{I}_{\typset_1})|\XXX\mb{I}_{\typset_1}} + \mb{I}_{\typset_2}\ex{f(\X\mb{I}_{\typset_2})|\XXX\mb{I}_{\typset_2}} + \mb{I}_{(\typset_1\sqcup \typset_2)^c}f(0)
...
\begin{align*}
\mb{E}\bigg[\ex{f(\X\mb{I}_{\typset_1\sqcup \typset_2})|\XXX\mb{I}_{\typset_1\sqcup \typset_2}}&g(\XX\mb{I}_{\typset_1\sqcup \typset_2})h(\XXX\mb{I}_{\typset_1\sqcup \typset_2})\bigg]\\
&= \ex{\mb{I}_{\typset_1}\ex{f(\X\mb{I}_{\typset_1})|\XXX\mb{I}_{\typset_1}}g(\XX\mb{I}_{\typset_1})h(\XXX\mb{I}_{\typset_1})} +\\
&\hspace{1 cm} \ex{\mb{I}_{\typset_2}\ex{f(\X\mb{I}_{\typset_2})|\XXX\mb{I}_{\typset_2}}g(\XX\mb{I}_{\typset_2})h(\XXX\mb{I}_{\typset_2})} + \\
&\hspace{1 cm} \ex{\mb{I}_{(\typset_1\sqcup \typset_2)^c}f(0)g(0)h(0)}\\
&= \ex{\mb{I}_{\typset_1}f(\X\mb{I}_{\typset_1})g(\XX\mb{I}_{\typset_1})h(\XXX\mb{I}_{\typset_1})} + \ex{\mb{I}_{\typset_2}f(\X\mb{I}_{\typset_2})g(\XX\mb{I}_{\typset_2})h(\XXX\mb{I}_{\typset_2})} +\\
&\hspace{1 cm} \ex{\mb{I}_{(\typset_1\sqcup \typset_2)^c}f(0)g(0)h(0)}\\
&= \ex{f(\X\mb{I}_{\typset_1\sqcup \typset_2})g(\XX\mb{I}_{\typset_1\sqcup \typset_2})h(\XXX\mb{I}_{\typset_1\sqcup \typset_2})}
\end{align*}
...
\begin{defn}
Let \(\{t_i\}\) be denote a finite set of times \(0=t_0 <t_1 <\cdots < t_n=1\). Let \(\X\in \cad([0,T],\spce)\) where \(\spce\) is a separable and complete space with respect to the metric \(d\). Define,

\[\modu{\X}([t_{i-1},t_i)) = \sup_{\tt,\t\in [t_{i-1},t_i)} d(\X{t},\X{\tt}).\]

Then for all \(\delta \in (0,T)\),

\[\cmodu{\X}(\delta) = \inf_{\{t_i\}: \min_i |t_i - t_{i-1}| > \delta} \max_{i} \modu{\X}([t_{i-1},t_i))\]
