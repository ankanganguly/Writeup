...
f&\te{ is a }[0,\const\indx{}] \te{-valued mapping and } \pmap{\v}(\XXX\cind{}\tip{}) = \{(\rt\indx{\it}\vind{\v},\mark{\it}_\v):\it\in\mb{N}\}.\nonumber
\end{align} 
