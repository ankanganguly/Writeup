...
\[\exmu{\m\sln{n}}{f(\XX{}{\t})}  = \exmu{\mm{n}}{\exmu{\m\sln{n}}{f(\XX{}{\t})|\XX{}{0}}} \ra \exmu{\mm{n}}{\exmu{\m}{f(\XX{}{\t})|\XX{}{0}}} \ra \exmu{\mm}{\exmu{\m}{f(\XX{}{\t})|\XX{}{0}}} = \exmu{\m}{f(\XX{}{\t})}\]
...
\begin{align*}
\exmu{\m\sln{n}}{f(\XX{}{0},\XX{}{\t\indx{2}},\dots,\XX{}{\t\indx{\it}})} &= \exmu{\mm{n}}{\exmu{\m\sln{n}}{f(\XX{}{0},\XX{}{\t\indx{2}},\dots,\XX{}{\t\indx{\it}})|\XX{}{0}}}\\
...
\begin{lem}
Assume the notation and assumptions from Lemmas \ref{subsec::Some:Lem::genfiniteSDE} and \ref{subsec::Some:Lem::PPtoSDE} hold under the probability measure \(\m\sln{}\ts{}\). Suppose under \(\mm{}{}{}\), \(\X\cind{}\tip{}\) solves,
...
\begin{equation}
\frac{d\m\sln{}\ts{\t}}{d\mm{}{\t}{}}= \frac{d\m\sln{}\ts{0}}{d\mm{}{0}{}}\left(\prod_{0< \rt{\it}\leq \t} \ratee{\t}(\mark{\it})\right)\exp\left(-\int{(0,\t]\times \S} (\ratee{\tt}(\s) - 1)\,d\tt\alt{\Sm}(d\s)\right)
