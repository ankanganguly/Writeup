...
\begin{align*}
\pr\left(\sup_n \omega'_{\X{}{}{n}}(\delta) > \epsilon\right) &= \pr\left(\sup_n\inf_{\{\t\sln{\it}\}}\sup_\it\sup_{\tt,\ttt \in [\t\sln{\it-1},\t\sln{\it})} \sum_{\v \in  V} \b{\v}|(\X{\v}{\tt}{n} - \X{\v}{\ttt}{n}| > \epsilon \right)\\
&\leq \pr\left(\sup_n \left(\omega'_{\proj{ V\sln{M}}{\T}(\X{}{}{n})}(\delta) + \omega'_{\proj{\left( V\sln{M}\right)^c}{\T}(\X{}{}{n})}(\delta)\right) > \ep\right)\\
&\leq \pr\left(\sup_n \omega'_{\proj{ V\sln{M}}{\T}(\X{}{}{n})}(\delta) > \ep/2\right) \os{\delta\searrow 0}{\ra} 0.
\end{align*}
