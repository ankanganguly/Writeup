...
&\leq \pr\left(\sup_\numb \left(\omega'_{\proj{ V\pup{M}}{\T}(\X{}{}{\numb})}(\delta) + \omega'_{\proj{\left( V\pup{M}\right)^c}{\T}(\X{}{}{\numb})}(\delta)\right) > \ep\right)\\
&\leq \pr\left(\sup_\numb \omega'_{\proj{ V\pup{M}}{\T}(\X{}{}{\numb})}(\delta) > \ep/2\right) \os{\delta\searrow 0}{\ra} 0.
\end{align*}
...
for all \(\s\in \S\). Furthermore, \(\alt{\m{}{}{}} = \proj{\tree\pup{1}}{\T}(\m{}{}{})\).
...
\[\left(\proj{\tree\pup{1}}{\T}(\X{}{})\right)^\t = \left(\proj{\tree\pup{1}}{\T}(\X{}{})\right)^0 + \sum_{\v \in \tree\pup{1}}\ev{\v}\int_\S\int_0^\t \s\,\poiss{\v}\left(d\tt,\left(0,\rate{\v}(\X{}{\tt-},\s)\right],d\s\right).\]

However, this is not \(\F{\tree\pup{1}}{\t}\)-adapted. Let \(\rp{} = \{(\rt{\it},\mark{\it})\} = \pmap{\tree\pup{1}}(\X{}{}).\) Then,

\[\left(\proj{\tree\pup{1}}{\T}(\X{}{})\right)^\t = \left(\proj{\tree\pup{1}}{\T}(\X{}{})\right)^0 + \sum_{0 < \rt{\it} \leq t}\mark{\it}\]
...
&= \exmu{\rxvtts{}{}\sim \proj{\tree\pup{1}}{\T}(\m{}{}{})}{\rate{}(\rxvtt{\tree\pup{1}}{\t-},\s)|\rxvtts{\{\root,1\}}{[0,\t)} = \X{\{\v,\root\}}{[0,\t)}}\\
&= \exmu{\cm_\t\left(\X{\{\v,\root\}}{[0,\t)},\proj{\tree\pup{1}}{\T}(\m{}{}{})\right)}{\rate{}(\X{\tree\pup{1}}{\t-},\s)}\\
