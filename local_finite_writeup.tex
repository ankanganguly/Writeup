...
\left\{\rt\indx{\apath{1}(\it)} \leq \rtt\indx{\apath{2}(\it)}\right\} &\te{ if } \apath{}(\it+1) - \apath{}(\it) = \ev\vind{1}\\
\left\{\rt\indx{\apath{1}(\it)} > \rtt\indx{\apath{2}(\it)}\right\} &\te{ if } \apath{}(\it+1) - \apath{}(\it) = \ev\vind{2}
\end{cases}\\
