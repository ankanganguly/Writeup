...
To prove existence, we use Picard iterations. Define \(\rxvtn{}{\t}{0} \defeq \X{}{0}\) for all \(\t \in [0,\T]\). Define,
...
\[\alt{\X{\v}{\cdot}} = \rxvtn{\v}{\t}{\sv{}{\V}} + \int_\S \int_0^\cdot \s\,\poiss{\v}(d\tt,(0,\rate{\v}(\alt{\X{}{\tt-}},\s)],d\s).\]

Then \(\rxvtn{}{\t+\cdot}{\sv{}{\V}} \deq \alt{\X{}{\cdot}}\). By the definition of \(\X{}{}{\sv{}{\V}}\), \(\alt{\X{}{}} \deq \X{}{}{\rxvtn{}{\t}{\sv{}{\V}}}\) as desired.
...
\[\crate{}{}(\X{\{\v,\root\}}{[0,\t)}{1},\s) = \exmu{\cm_\t(\X{\{\v,\root\}}{[0,\t)}{1},\mmm{}{}{1})}{\rate{}(\rxvtn{}{\t-}{1},\s)}.\]
...
\begin{align}
\rxvtn{\{\v,\root\}}{\t}{1} = \rxvtn{\{\v,\root\}}{0}{1} &+ \ev{\v}\int_\S\int_{(0,\crate{}{}(\X{\{\v,\root\}}{[0,\tt)}{1},\s)]}\int_{(0,t]}\s\,\poiss{\v}(d\tt,d\r,d\s)\nonumber\\
...
\[\crate{\rp{}}{\t}(\X{}{[0,\t)}{1},\mark{}) = \sum_{\v\in \tree\pup{1}\setminus\{\root\}}\sum_{\s\in \S} \mb{I}_{\mark{} = \s\ev{\v}}\crate{}{}(\X{\{\v,\root\}}{[0,\t)}{1},\s) + \sum_{\s\in\S}\mb{I}_{\mark{} = \s\ev{\root}}\rate{\root}(\rxvtn{}{\t-}{1},\s).\]

Then \(\piV{\{\v,\root\}}{\T}(\rp{})\defeq \pmap{\{\v,\root\}}(\X{}{}{1})\) \tr{notation?} has \(\F{\tree\pup{1}}{}\)-predictable intensity,

\[\rate{\piV{\{\v,\root\}}{\T}(\rp{})}^{\t}(\X{}{[0,\t)}{1},\mark{}) = \sum_{\s\in \S} \left(\mb{I}_{\mark{} = \s\ev{\v}}\crate{}{}(\X{\{\v,\root\}}{[0,\t)}{1},\s) + \mb{I}_{\mark{} = \s\ev{\root}}\rate{\root}(\rxvtn{}{\t-}{1},\s)\right)\te{ for } \kappa \in \S^{\{\v,\root\}}.\]
...
&=\exmu{\m{}{}{1}}{\sum_{\s\in \S}\left(\mb{I}_{\kappa = \s\ev{\v}} \crate{}{}(\X{\{\v,\root\}}{[0,\t)}{1},\s) + \mb{I}_{\kappa = \s\ev{\root}}\rate{\root}(\rxvtn{}{\t-}{1},\s)\right)\middle|\F{\{\v,\root\}}{\t-}}\\
&=\sum_{\s\in \S}\mb{I}_{\kappa = \s\ev{\v}} \crate{}{}(\X{\{\v,\root\}}{[0,\t)}{1},\s) + \sum_{\s\in \S}\mb{I}_{\kappa = \s\ev{\root}}\exmu{\m{}{}{1}}{\rate{\root}(\rxvtn{}{\t-}{1},\s)\middle|\F{\{\v,\root\}}{\t-}}\\
...
&=\sum_{\s\in \S}\mb{I}_{\kappa = \s\ev{\v}} \crate{}{}(\X{\{\v,\root\}}{[0,\t)}{1},\s) + \sum_{\s\in \S}\mb{I}_{\kappa = \s\ev{\root}}\exmu{\cm_t(\X{\{\root,\v\}}{[0,\t)}{1},\m{}{}{1})}{\rate{}(\rxvtn{\tree\pup{1}}{\t-}{1},\s)}\\
...
\begin{align*}
\X{\v}{0} + \int_{(0,\t]}\int_\S\int_{(0,\rate{}(\X{\cl{\v}}{\tt-},\s)]}\s\poiss{\v}(d\r,d\s,d\tt) &= \X{\v}{0} + \int_{(0,\t]}\int_\S\int_{(0,\rate{}(\rxvtn{\cl{\v}}{\tt-}{\numb},\s)]}\s\poiss{\v}(d\r,d\s,d\tt)\\
&=\rxvtn{\v}{\t}{\numb} = \X{\v}{\t}.
\end{align*}
