...
%DIF DEL old_local_finite_writeup.tex   Tue Dec 11 10:00:29 2018
%DIF ADD local_finite_writeup.tex       Wed Dec 12 20:58:20 2018
...
%DIF -------
\newcommand{\slnvind}[2]{^{(#1),#2}}				%vindsln combine %DIF > 
%DIF -------
...
%DIF 203a203-204
\renewcommand{\part}{\mc{T}}					%Partition %DIF > 
\newcommand{\topo}{\mc{T}}						%Topology %DIF > 
%DIF -------
...
%DIF 209a211-212
\newcommand{\indcs}[2]{_{#1,#2}}				%two indices %DIF > 
\newcommand{\indxset}[1]{_{#1}}					%index set %DIF > 
%DIF -------
...
%\DIFdelbegin %DIFDELCMD < \begin{longtable}{c|c|c|c}
%%DIFDELCMD < %%%
%\DIFdelend \DIFaddbegin \begin{longtable}{|c|c|c|c|}
%\hline \DIFaddend Macro Command & Arguments & Symbol & Meaning\\\hline
%\DIFaddbegin \multicolumn{4}{|c|}{General Shorthand Macros}\\\hline
%\DIFadd{\tbs skipLine }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{skips a line}\\\hline
%\DIFadd{\tbs mb }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{math bubble font}\\\hline
%\DIFadd{\tbs mc }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{math calligraphy font}\\\hline
%\DIFadd{\tbs ms }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{math script font}\\\hline
%\DIFadd{\tbs ra }& \DIFadd{0 }& \DIFadd{\(\ra\) }& \DIFadd{converges}\\\hline
%\DIFadd{\tbs ov }& \DIFadd{0 }& \DIFadd{\(\ov{\cdot}\) }& \DIFadd{overline}\\\hline
%\DIFadd{\tbs os }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{overset}\\\hline
%\DIFadd{\tbs un }& \DIFadd{0 }& \DIFadd{\(\un{\cdot}\) }& \DIFadd{underline}\\\hline
%\DIFadd{\tbs te }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{regular text font}\\\hline
%\DIFadd{\tbs ep }& \DIFadd{0 }& \DIFadd{\(\ep\) }& \DIFadd{epsilon}\\\hline
%\DIFadd{\tbs tr }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{red text}\\\hline
%\DIFadd{\tbs tb }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{blue text}\\\hline
%\DIFadd{\tbs tg }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{green text}\\\hline
%\DIFadd{\tbs labe }& \DIFadd{1 }& \DIFadd{\(\labe{Label}\) }& \DIFadd{label}\\\hline
%\DIFadd{\tbs tbs }& \DIFadd{0 }& \DIFaddend \tbs \DIFaddbegin & \DIFadd{back slash}\\\hline
%\DIFadd{\tbs purpose }& \DIFadd{0 }& \DIFadd{\(\purpose\) }& \DIFadd{purpose header}\\\hline
%\DIFadd{\tbs pfsum }& \DIFadd{0 }& \DIFadd{\(\pfsum\) }& \DIFadd{Proof summary header}\\\hline
%\DIFadd{\tbs usein }&\DIFadd{0  }& \DIFadd{\(\usein\) }& \DIFadd{Use in header}\\\hline
%\DIFadd{\tbs app }& \DIFadd{0 }& \DIFadd{\(\app\) }& \DIFadd{Applied header}\\\hline
%\DIFadd{\tbs ind }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{indent }\\\hline
%\DIFadd{\tbs lin }& \DIFadd{0 }& \DIFadd{(no representation) }& \DIFadd{horizontal line}\\\hline
%\DIFadd{\tbs }\DIFaddend pr & 0 & \(\pr\) & probability\\\DIFaddbegin \hline
%\DIFadd{\tbs ex }& \DIFadd{1 }& \DIFadd{\(\ex{\cdot}\) }& \DIFadd{expectation}\\\hline
%\DIFadd{\tbs exmu }& \DIFadd{2 }& \DIFadd{\(\exmu{\cdot}{\cdot}\) }& \DIFadd{expectation wrt a measure}\\\hline
%\DIFadd{\tbs deq }& \DIFadd{0 }& \DIFadd{\(\deq\) }& \DIFadd{equal in distribution}\\\hline	
%\DIFadd{\tbs defeq }& \DIFadd{0 }& \DIFadd{\(\defeq\) }& \DIFadd{definition equals}\\\hline	
%\DIFadd{\tbs msr }& \DIFadd{0 }& \DIFadd{\(\msr\) }& \DIFadd{set of measures}\\\hline
%\DIFadd{\tbs pmsr }& \DIFadd{0 }& \DIFadd{\(\pmsr\) }& \DIFadd{set of probability measures}\\\hline	
%\DIFadd{\tbs cad }& \DIFadd{0 }& \DIFadd{\(\cad\) }& \DIFadd{set of c\`adl\`ag functions}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 2.1}}\\\hline
%\multicolumn{4}{|c|}{Base Commands}\\\hline
%\DIFadd{\tbs root }& \DIFadd{0 }& \DIFadd{\(\root\) }& \DIFadd{root}\\\hline
%\DIFadd{\tbs v }& \DIFadd{0 }& \DIFadd{\(\v\) }& \DIFadd{typical vertex}\\\hline
%\DIFadd{\tbs vv }& \DIFadd{0 }& \DIFadd{\(\vv\) }& \DIFadd{typical 2nd vertex}\\\hline
%\DIFadd{\tbs vvv }& \DIFadd{0 }& \DIFadd{\(\vvv\) }& \DIFadd{typical 3rd vertex}\\\hline
%\DIFadd{\tbs U }& \DIFadd{0 }& \DIFadd{\(\U\) }& \DIFadd{typical vertex set}\\\hline
%\DIFadd{\tbs UU }& \DIFadd{0 }& \DIFadd{\(\UU\) }& \DIFadd{typical 2nd vert set}\\\hline
%\DIFadd{\tbs UUU }& \DIFadd{0 }& \DIFadd{\(\UUU\) }& \DIFadd{typical 3rd vert}\\\hline
%\DIFadd{\tbs S }& \DIFadd{0 }& \DIFadd{\(\S\) }& \DIFadd{State space}\\\hline
%\DIFadd{\tbs s }& \DIFadd{0 }& \DIFadd{\(\s\) }& \DIFadd{elt of S}\\\hline
%\DIFadd{\tbs sv }& \DIFadd{0 }& \DIFadd{\(\sv\) }& \DIFadd{typ elt of XState}\\\hline
%\DIFadd{\tbs b }& \DIFadd{0 }& \DIFadd{\(\b\) }& \DIFadd{inf dim norm coeffs}\\\hline
%\DIFadd{\tbs ev }& \DIFadd{0 }& \DIFadd{\(\ev\) }& \DIFadd{standard basis}\\\hline
%\DIFadd{\tbs T }& \DIFadd{0 }& \DIFadd{\(\T\) }& \DIFadd{time bound}\\\hline
%\DIFadd{\tbs x }& \DIFadd{0 }& \DIFadd{\(\x\) }& \DIFadd{typical elt of Omega}\\\hline
%\DIFadd{\tbs t }& \DIFadd{0 }& \DIFadd{\(\t\) }& \DIFadd{typical time}\\\hline
%\DIFadd{\tbs sset }& \DIFadd{0 }& \DIFadd{\(\sset\) }& \DIFadd{sample set}\\\hline
%\DIFadd{\tbs proj }& \DIFadd{0 }& \DIFadd{\(\proj\) }& \DIFadd{projection operator}\\\hline
%\DIFadd{\tbs tt }& \DIFadd{0 }& \DIFadd{\(\tt\) }& \DIFadd{typical time 2}\\\hline
%\DIFadd{\tbs ttt }& \DIFadd{0 }& \DIFadd{\(\ttt\) }& \DIFadd{typical time 3}\\\hline
%\DIFadd{\tbs F }& \DIFadd{0 }& \DIFadd{\(\F\) }& \DIFadd{Filtrations}\\\hline
%\DIFadd{\tbs FG }& \DIFadd{0 }& \DIFadd{\(\FG\) }& \DIFadd{Filtrations}\\\hline
%\DIFadd{\tbs FH }& \DIFadd{0 }& \DIFadd{\(\FH\) }& \DIFadd{Filtrations}\\\hline
%\DIFadd{\tbs X }& \DIFadd{0 }& \DIFadd{\(\X\) }& \DIFadd{typ random process}\\\hline
%\DIFadd{\tbs IG }& \DIFadd{0 }& \DIFadd{\(\IG\) }& \DIFadd{Infinitesimal gens}\\\hline
%\DIFadd{\tbs IGr }& \DIFadd{0 }& \DIFadd{\(\IGr\) }& \DIFadd{IG rate}\\\hline
%\DIFadd{\tbs f }& \DIFadd{0 }& \DIFadd{\(\f\) }& \DIFadd{generic function}\\\hline
%\DIFadd{\tbs neigh }& \DIFadd{0 }& \DIFadd{\(\neigh\) }& \DIFadd{neighbor}\\\hline
%\DIFadd{\tbs dneigh }& \DIFadd{0 }& \DIFadd{\(\dneigh\) }& \DIFadd{double neighbor}\\\hline
%\multicolumn{4}{|c|}{Modifiers}\\\hline
%\DIFadd{\tbs vind }& \DIFadd{1 }& \DIFadd{\(\X\vind{\v}\) }& \DIFadd{indexed by v,V,U etc.}\\\hline
%\DIFadd{\tbs carp }& \DIFadd{1 }& \DIFadd{\(\S\carp{V}\) }& \DIFadd{Cartesian power}\\\hline
%\DIFadd{\tbs vsi }& \DIFadd{1 }& \DIFadd{\(\Omega\vsi{\v}\) }& \DIFadd{vertex set identifier}\\\hline
%\DIFadd{\tbs cind }& \DIFadd{1 }& \DIFadd{\(\ev\cind{\v}\) }& \DIFadd{component index}\\\hline
%\DIFadd{\tbs cl }&  & \DIFadd{\(\cl{\tree}\) }& \DIFadd{closure}\\\hline
%\DIFadd{\tbs tp }& \DIFadd{1 }& \DIFadd{\(\X\tp{\t}\) }& \DIFadd{Time of process}\\\hline
%\DIFadd{\tbs tip }& \DIFadd{1 }& \DIFadd{\(\X\tip{[0,\t)}\) }& \DIFadd{time interval process	}\\\hline
%\DIFadd{\tbs ts }& \DIFadd{1 }& \DIFadd{\(\proj\ts{\t}\) }& \DIFadd{time bound of set}\\\hline
%\DIFadd{\tbs slnvind }& \DIFadd{2 }& \DIFadd{\(\X\slnvind{n}{\v}\) }& \DIFadd{vindsln combine}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 2.2}}\\\hline
%\multicolumn{4}{|c|}{Base Commands}\\\hline
%\DIFadd{\tbs const }& \DIFadd{0 }& \DIFadd{\(\const\) }& \DIFadd{Constant}\\\hline
%\DIFadd{\tbs degr }& \DIFadd{0 }& \DIFadd{\(\degr\) }& \DIFadd{Max degree of graph}\\\hline
%\DIFadd{\tbs IGrg }& \DIFadd{0 }& \DIFadd{\(\IGrg\) }& \DIFadd{Fixed rate function}\\\hline
%\DIFadd{\tbs gdist }& \DIFadd{0 }& \DIFadd{\(\gdist\) }& \DIFadd{Graph distance}\\\hline
%\DIFadd{\tbs tree }& \DIFadd{0 }& \DIFadd{\(\tree\) }& \DIFadd{Tree}\\\hline
%\multicolumn{4}{|c|}{Modifiers}\\\hline
%\DIFadd{\tbs sln }& \DIFadd{1 }& \DIFadd{\(\X\sln{n}\) }& \DIFadd{sublimit numbering}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 2.3}}\\\hline
%\multicolumn{4}{|c|}{Base Commands}\\\hline
%\DIFadd{\tbs core }& \DIFadd{0 }& \DIFadd{\(\core\) }& \DIFadd{Core}\\\hline
%\DIFadd{\tbs cont }& \DIFadd{0 }& \DIFadd{\(\cont\) }& \DIFadd{space of cont. fs}\\\hline
%\DIFadd{\tbs delt }& \DIFadd{0 }& \DIFadd{\(\delt\) }& \DIFadd{change in f}\\\hline
%\DIFadd{\tbs ss }& \DIFadd{0 }& \DIFadd{\(\ss\) }& \DIFadd{2nd elt of \S}\\\hline
%\DIFadd{\tbs SS }& \DIFadd{0 }& \DIFadd{\(\SS\) }& \DIFadd{sub state space}\\\hline
%\DIFadd{\tbs poisses }& \DIFadd{0 }& \DIFadd{\(\poisses\) }& \DIFadd{all Poisson processes}\\\hline
%\DIFadd{\tbs poiss }& \DIFadd{0 }& \DIFadd{\(\poiss\) }& \DIFadd{Poisson process}\\\hline
%\DIFadd{\tbs leb }& \DIFadd{0 }& \DIFadd{\(\leb\) }& \DIFadd{Lebesgue measure}\\\hline
%\DIFadd{\tbs Sm }& \DIFadd{0 }& \DIFadd{\(\Sm\) }& \DIFadd{std msr on \S}\\\hline
%\DIFadd{\tbs rate }& \DIFadd{0 }& \DIFadd{\(\rate\) }& \DIFadd{rate}\\\hline
%\DIFadd{\tbs Fpo }& \DIFadd{0 }& \DIFadd{\(\Fpo\) }& \DIFadd{Picard mapping of SDE}\\\hline
%\DIFadd{\tbs r }& \DIFadd{0 }& \DIFadd{\(\r\) }& \DIFadd{space var for poiss}\\\hline
%\DIFadd{\tbs cconst }& \DIFadd{0 }& \DIFadd{\(\cconst\) }& \DIFadd{second constant}\\\hline
%\DIFadd{\tbs modu }& \DIFadd{0 }& \DIFadd{\(\modu\) }& \DIFadd{modulus of continuity}\\\hline
%\DIFadd{\tbs cmodu }& \DIFadd{0 }& \DIFadd{\(\cmodu\) }& \DIFadd{cadlag moc}\\\hline
%\multicolumn{4}{|c|}{Modifiers}\\\hline
%\DIFadd{\tbs deltf }& \DIFadd{1 }& \DIFadd{\(\triangle\deltf{f}\) }& \DIFadd{Specify delt function}\\\hline
%\DIFadd{\tbs alt }& \DIFadd{1 }& \DIFadd{\(\alt{\X}\) }& \DIFadd{alternate val}\\\hline
%\DIFadd{\tbs pra }& \DIFadd{1 }& \DIFadd{\(\m\pra{\X}\) }& \DIFadd{Append process}\\\hline
%\DIFadd{\tbs indx }& \DIFadd{1 }& \DIFadd{\(\rt\indx{i}\) }& \DIFadd{index}\\\hline
%\DIFadd{\tbs pst }& \DIFadd{1 }& \DIFadd{\(\pr\pst{\x}\) }& \DIFadd{Start of process}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 3}}\\\hline
%\multicolumn{4}{|c|}{Base Commands}\\\hline
%\DIFadd{\tbs m }& \DIFadd{0 }& \DIFadd{\(\m\) }& \DIFadd{typ measure}\\\hline
%\DIFadd{\tbs mm }& \DIFadd{0 }& \DIFadd{\(\mm\) }& \DIFadd{typ measure 2}\\\hline
%\DIFadd{\tbs mmm }& \DIFadd{0 }& \DIFadd{\(\mmm\) }& \DIFadd{typ measure 3}\\\hline
%\DIFadd{\tbs cm }& \DIFadd{0 }& \DIFadd{\(\cm\) }& \DIFadd{conditional msr funct}\\\hline
%\DIFadd{\tbs law }& \DIFadd{0 }& \DIFadd{\(\law\) }& \DIFadd{Law of a process}\\\hline
%\multicolumn{4}{|c|}{Modifiers}\\\hline
%\DIFadd{\tbs me }& \DIFadd{1 }& \DIFadd{\(\pr\me{\m}\) }& \DIFadd{Append measure}\\\hline
%\DIFadd{\tbs dnvind }& \DIFadd{1 }& \DIFadd{\(\dneigh\dnvind{\v}\) }& \DIFadd{vind for dneigh}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 4}}\\\hline
%\DIFadd{\tbs XX }& \DIFadd{0 }& \DIFadd{\(\XX\) }& \DIFadd{second random element}\\\hline
%\DIFadd{\tbs XXX }& \DIFadd{0 }& \DIFadd{\(\XXX\) }& \DIFadd{third random elt}\\\hline
%\DIFadd{\tbs rt }& \DIFadd{0 }& \DIFadd{\(\rt\) }& \DIFadd{typical rand time}\\\hline
%\DIFadd{\tbs rtt }& \DIFadd{0 }& \DIFadd{\(\rtt\) }& \DIFadd{typical rand time 2}\\\hline
%\DIFadd{\tbs it }& \DIFadd{0 }& \DIFadd{\(\it\) }& \DIFadd{iterator}\\\hline
%\DIFadd{\tbs mutex }& \DIFadd{0 }& \DIFadd{\(\mutex\) }& \DIFadd{Mutually exclusive}\\\hline
%\DIFadd{\tbs apath }& \DIFadd{0 }& \DIFadd{\(\apath\) }& \DIFadd{path for CI proof}\\\hline
%\DIFadd{\tbs pathset }& \DIFadd{2 }& \DIFadd{\(\pathset{i}{j}\) }& \DIFadd{A space of paths}\\\hline
%\DIFadd{\tbs pathsete }& \DIFadd{2 }& \DIFadd{\(\pathsete{i}{j}\) }& \DIFadd{union over pathset}\\\hline
%\DIFadd{\tbs pathseted }& \DIFadd{2 }& \DIFadd{\(\pathseted{i}{j}(\t)\) }& \DIFadd{pathsete with t}\\\hline
%\DIFadd{\tbs evnt }& \DIFadd{0 }& \DIFadd{\(\evnt\) }& \DIFadd{Typical event}\\\hline
%\DIFadd{\tbs rv }& \DIFadd{0 }& \DIFadd{\(\rv\) }& \DIFadd{Typical rand elt}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 5.1}}\\\hline
%\multicolumn{4}{|c|}{Base Commands}\\\hline
%\DIFadd{\tbs pmap }& \DIFadd{0 }& \DIFadd{\(\pmap\) }& \DIFadd{Markov to MPP	}\\\hline
%\DIFadd{\tbs mark }& \DIFadd{0 }& \DIFadd{\(\mark\) }& \DIFadd{Typical mark}\\\hline
%\DIFadd{\tbs rp }& \DIFadd{0 }& \DIFadd{\(\rp\) }& \DIFadd{typ point process}\\\hline
%\DIFadd{\tbs Tset }& \DIFadd{0 }& \DIFadd{\(\Tset\) }& \DIFadd{finite time subset}\\\hline
%\DIFadd{\tbs typset }& \DIFadd{0 }& \DIFadd{\(\typset\) }& \DIFadd{Typical set}\\\hline
%\DIFadd{\tbs ratee }& \DIFadd{0 }& \DIFadd{\(\ratee\) }& \DIFadd{general rate}\\\hline
%\DIFadd{\tbs crate }& \DIFadd{0 }& \DIFadd{\(\crate\) }& \DIFadd{conditional rate}\\\hline
%\DIFadd{\tbs upcrs }& \DIFadd{0 }& \DIFadd{\(\upcrs\) }& \DIFadd{upcrossing}\\\hline
%\DIFadd{\tbs cratee }& \DIFadd{0 }& \DIFadd{\(\cratee\) }& \DIFadd{general conditional rate}\\\hline
%\multicolumn{4}{|c|}{Modifiers}\\\hline
%\DIFadd{\tbs gid }& \DIFadd{1 }& \DIFadd{\(\rt\gid{M}\) }& \DIFadd{generic identifier}\\\hline
%\DIFadd{\tbs gidd }& \DIFadd{1 }& \DIFadd{\(\rt\gidd{\Tset}\) }& \DIFadd{second gen ident}\\\hline
%\multicolumn{4}{|c|}{\textbf{Section 5.2}}\\\hline
%\multicolumn{4}{|c|}{Base Commands}\\\hline
%\DIFadd{\tbs dense }& \DIFadd{0 }& \DIFadd{\(\dense\) }& \DIFadd{Typ density}\\\hline
%\DIFadd{\tbs cdense }& \DIFadd{0 }& \DIFadd{\(\cdense\) }& \DIFadd{Cond density}\\\hline
%\DIFadd{\tbs ds }& \DIFadd{0 }& \DIFadd{\(\ds\) }& \DIFadd{mapping in density}\\\hline
%\DIFadd{\tbs c }& \DIFadd{0 }& \DIFadd{\(\c\) }& \DIFadd{child function}\\\hline
%\DIFadd{\tbs p }& \DIFadd{0 }& \DIFadd{\(\p\) }& \DIFadd{parent function}\\\hline
%\multicolumn{4}{|c|}{Modifiers}\\\hline
%\DIFadd{\tbs prats }& \DIFadd{2 }& \DIFadd{\(\crate\prats{\rp}{\t}\) }& \DIFadd{pra and ts}\\\hline
%\multicolumn{4}{|c|}{\textbf{Appendix A}}\\\hline
%\DIFadd{\tbs spce }& \DIFadd{0 }& \DIFadd{\(\spce\) }& \DIFadd{arbitrary space}\\\hline
%\DIFadd{\tbs xx }& \DIFadd{0 }& \DIFadd{\(\xx\) }& \DIFadd{typ path val2}\\\hline
%\DIFadd{\tbs xxx }& \DIFadd{0 }& \DIFadd{\(\xxx\) }& \DIFadd{typ path val3}\\\hline
%\multicolumn{4}{|c|}{\textbf{Appendix B}}\\\hline
%\DIFadd{\tbs evs }& \DIFadd{0 }& \DIFadd{\(\evs\) }& \DIFadd{Set of events}\\\hline
%\DIFadd{\tbs mspce }& \DIFadd{0 }& \DIFadd{\(\mspce\) }& \DIFadd{Mark space}\\\hline
%\DIFadd{\tbs rpg }& \DIFadd{0 }& \DIFadd{\(\rpg\) }& \DIFadd{ground process}\\\hline
%\multicolumn{4}{|c|}{\textbf{Appendix C}}\\\hline
%\DIFadd{\tbs dist }& \DIFadd{0 }& \DIFadd{\(\dist\) }& \DIFadd{general metric}\\\hline
%\DIFadd{\tbs inte }& \DIFadd{0 }& \DIFadd{\(\inte\) }& \DIFadd{Interval}\\\hline
%\DIFadd{\tbs part}& \DIFadd{0 }& \DIFadd{\(\part\) }& \DIFadd{Partition}\\\hline
%\DIFadd{\tbs topo }& \DIFadd{0 }& \DIFadd{\(\topo\) }& \DIFadd{Topology}\\\hline
%\multicolumn{4}{|c|}{Appendix Modifiers}\\\hline
%\DIFadd{\tbs vindpst }& \DIFadd{2 }& \DIFadd{\(\rate\vindpst{\v}{\sv\vsi{V}}\) }& \DIFadd{vind and pst}\\\hline
%\DIFadd{\tbs slnpst }& \DIFadd{2 }& \DIFadd{\(\rate\slnpst{n}{\sv\vsi{V}}\) }& \DIFadd{sln and pst}\\\hline
%\DIFadd{\tbs mepst }& \DIFadd{2 }& \DIFadd{\(\pr\mepst{i}{\x}\) }& \DIFadd{me and pst}\\\hline
%\DIFadd{\tbs indxcind }& \DIFadd{2 }& \DIFadd{\(f\indxcind{k}{1}\) }& \DIFadd{indx and cind}\\\hline
%\DIFadd{\tbs indcs }& \DIFadd{2 }& \DIFadd{\(\part\indcs{i}{n}\) }& \DIFadd{two indices}\\\hline
%\DIFadd{\tbs indxset }& \DIFadd{1 }& \DIFadd{\(\spce\indxset{A}\) }& \DIFadd{index set}\\\hline
...
\DIFaddbegin \DIFadd{LaTeX diff was unable to parse the table I added here.} \DIFaddend
...
\begin{itemize}
\item \DIFdelbegin \DIFdel{Complete notation macros
}\DIFdelend \DIFaddbegin \DIFadd{The proof of uniqueness in theorem \ref{sec::Main:Thm::Local SDE} shows that any solution to the local SDE is the marginal distribution of a weak solution to equation }\eqref{subsec::Well-:Eqn::SDE}\DIFadd{. However, I've only proved that such equations have unique strong solutions. Make sure that this equation has a unique weak solution in law.
}\DIFaddend 

\item \DIFdelbegin \DIFdel{Try removing references to measure space \(\pmsr(\cdot)\) in section 2.
}\DIFdelend \DIFaddbegin \DIFadd{Update the purpose and used in headers.
}\DIFaddend 

\item \DIFdelbegin \DIFdel{Finish all proofs}\DIFdelend \DIFaddbegin \DIFadd{Standardize Poisson integration order
}

\item \DIFadd{Standardize capitalization (or lack thereof) of "lemma","theorem","proposition" and "corollary"}\DIFaddend .
\DIFaddbegin 

\item \DIFadd{Look for resources regarding well-posedness of infinite Poisson SDEs and local weak convergence of such SDEs. Most results in section 2 seem extremely standard.
}

\item \DIFadd{revise literature review.
...
\purpose Assumption \ref{subsec::Assum:Assu::Local} implies Assumption \ref{subsec::Assum:Assu::CI}, so all results \DIFdelbegin \DIFdel{for Assumption \ref{subsec::Assum:Assu::CI} hold for }\DIFdelend \DIFaddbegin \DIFadd{that hold given Assumption \ref{subsec::Assum:Assu::CI} also hold given }\DIFaddend Assumption \ref{subsec::Assum:Assu::Local}. This assumption adds an additional symmetry assumption. We also work on trees so we do not have to deal with cycles (which add extra dependencies making the problem harder to analyze). Furthermore, this assumption is sufficient for Theorem \ref{sec::Main:Thm::Local SDE} (existence and uniqueness of a local representation of \(\m \defeq \law(\X)\)).
...
\purpose This is necessary for obvious reasons. If \(\X\) is not well-defined, then there is no longer any point in deriving any results about its properties. The infinitesimal generator representation of \(\X\) is used to prove convergence of the finite-dimensional approximations of \(\X\) to \(\X\). \DIFaddbegin \DIFadd{If I find a convenient SDE version of the proof of convergence, (which may be necessary for local-weak convergence or cases in which the full process is history-dependent), then I may discard this lemma.
}\DIFaddend 
...
\app \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite[Theorem 3.9]{Lig85} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{Lemma \ref{sec::Infin:Lem::IPS-IG} }\DIFaddend and Assumption \ref{subsec::Assum:Assu::CI}.

\begin{proof}
By \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite[Theorem 3.9 (a) and (b)]{Lig85}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{lemma \ref{sec::Infin:Lem::IPS-IG}}\DIFaddend , it suffices to show that:
...
\usein Proposition \ref{subsec::Well-:Prop::SDE=IG}, Lemma \DIFaddbegin \DIFadd{\ref{subsec::Well-:Lem::weaksoln}, Lemma }\DIFaddend \ref{sec::Proof1:Lem::Decomposition} and section \ref{subsec::ProofU:sec::Proof2}.
...
\usein \DIFdelbegin \DIFdel{Lemma }\DIFdelend \DIFaddbegin \DIFadd{Intermediate result for Lemma \ref{subsec::Well-:Prop::SDEWP}, Lemma }\DIFaddend \ref{subsec::Well-:Lem::GronwallPrep} and Proposition \ref{subsec::Well-:Prop::SDE=IG}. Proof is referenced in Lemma \ref{sec::Proof1:Lem::Decomposition}.
...
\ind Fix any \(\ep > 0\). Let \(\psi\) be a concave, monotonic, upper-bound of \(\phi\) such that \DIFdelbegin \DIFdel{\(\psi(0) = 0\) }\DIFdelend \DIFaddbegin \DIFadd{\(\psi(0) = \ep\) }\DIFaddend (see Lemma \ref{sec::TL:Lem::concbd}). By Jensen's inequality,
...
\DIFaddbegin \DIFadd{Since \(\ep > 0\) was chosen arbitrarily, it follows that,
}

\[\DIFadd{\lim_{\sv\vsi{V} \ra \alt{\sv}\vsi{V}} \ex{\|f(\X) - f(\alt{\X})\|_\T} = 0.}\]

\DIFaddend This concludes the proof that \(\X\) is Feller.
\end{enumerate}
...
\DIFaddbegin \begin{lem}
\DIFadd{Suppose Assumption \ref{subsec::Assum:Assu::CI} holds. Let \((\X,\{\poiss\vind{\v}:\v\in V\})\) be any weak solution to equation }\eqref{subsec::Well-:Eqn::SDE} \DIFadd{such that \(\X\) is adapted to \(\sigma(\X\tp{0})\vee\F\pra{\{\poiss\vind{\v}\}}\), where \(\F\pra{\{\poiss\vind{\v}\}}\) is the natural filtration of \(\{\poiss\vind{\v}\}\). Suppose also that \(\{\poiss\vind{\v}\}\) is still a Poisson process with the same rate after conditioning on the event \(\{\X\ts{0} = \sv\vsi{V}\}\) for all \(\sv\vsi{V} \in \S\carp{V}\). Let \(\alt{\X}\) be the unique strong solution to the same equation. Then \(\law(\X) = \law(\alt{\X})\).
}\label{subsec::Well-:Lem::weaksoln}
\end{lem}
\DIFadd{\labe{subsec::Well-:Lem::weaksoln}
}

\DIFadd{\purpose Yields conditions under which a weak solution to equation }\eqref{subsec::Well-:Eqn::SDE} \DIFadd{has the same law as any strong solution to the same equation. In section \ref{subsec::ProofU:sec::Proof2}, I characterize the law of a certain process as the weak solution to equation }\eqref{subsec::Well-:Eqn::SDE}\DIFadd{. This lemma ensures my characterization is unique.
}

\DIFadd{\pfsum Given a weak solution, I show that these conditions are sufficient to ensure that the weak solution is equal to the strong solution given the Poisson process from the weak solution.
}

\DIFadd{\usein Theorem \ref{sec::Main:Thm::Local SDE}, Section \ref{subsec::ProofU:sec::Proof2}.
}

\DIFadd{\app Assumption \ref{subsec::Assum:Assu::CI}, Proposition \ref{subsec::Well-:Prop::SDEWP}.
}

\begin{proof}
\DIFadd{Because \(\X\) is adapted to \(\sigma(\X\tp{0})\vee\F\pra{\{\poiss\vind{\v}\}}\), for every \(\t\in [0,\T]\), there exists a measurable mapping \(F\ts{\t}:\S\carp{V}\times \left(\otimes_{i=0}^\infty ([0,\t)\times\mb{R}_+\times\S\carp{V})^i\right)\ra \S\carp{V}\) such that,
}

\[\DIFadd{\X\tp{\t} = F\ts{\t}\left(\X\tp{0},\{\poiss\vind{\v}((\tt,\r,\alt{\sv}\vsi{V})):\v\in V,\tt \in [0,\t),\r\in\mb{R}_+,\alt{\sv}\vsi{V} \in \S\carp{V}\}\right).}\]

\DIFadd{Assume \(\alt{X}\) is defined on a probability space with Poisson processes \(\{\alt{\poiss}\vind{\v}\}\) (the intensity measures of these processes is given in Proposition \ref{subsec::Well-:Prop::SDEWP}). By uniqueness of the strong solution,
}

\[\DIFadd{\alt{X}\tp{\t} = F\ts{\t}\left(\alt{\X}\tp{0},\{\alt{\poiss}\vind{\v}((\tt,\r,\alt{\sv}\vsi{V})):\v\in V,\tt \in [0,\t),\r\in\mb{R}_+,\alt{\sv}\vsi{V} \in \S\carp{V}\}\right).}\]

\DIFadd{Let \(\X\pst{\sv\vsi{V}}\) be \(\X\) conditioned on the event \(\{\X\tp{0} = \sv\vsi{V}\}\). Similarly, set \(\poiss\vindpst{\v}{\sv\vsi{V}}\) to be \(\poiss\vind{\v}\) conditioned on the event \(\{\X\tp{0} = \sv\vsi{V}\}\). Finally, let \(\alt{\X}\pst{\sv\vsi{V}}\) be \(\alt{\X}\)  conditioned on the event \(\{\alt{\X}\tp{0} = \sv\vsi{V}\}\). By assumption, \(\poiss\vindpst{\v}{\sv\vsi{V}}\) are Poisson processes with the same intensity as \(\alt{\poiss}\vind{\v}\). Thus, for any \(\t \in [0,\T]\),
}

\begin{align*}
\DIFadd{\X\pst{\sv\vsi{V}}\tp{t} }&\DIFadd{= F\ts{\t}\left(\sv\vsi{V},\{\poiss\vindpst{\v}{\sv\vsi{V}}((\tt,\r,\alt{\sv}\vsi{V})):\v\in V,\tt \in [0,\t),\r\in\mb{R}_+,\alt{\sv}\vsi{V} \in \S\carp{V}\}\right)}\\
&\DIFadd{\deq F\ts{\t}\left(\sv\vsi{V},\{\alt{\poiss}\vind{\v}((\tt,\r,\alt{\sv}\vsi{V})):\v\in V,\tt \in [0,\t),\r\in\mb{R}_+,\alt{\sv}\vsi{V} \in \S\carp{V}\}\right)}\\
&\DIFadd{= \alt{X}\pst{\sv\vsi{V}}\tp{\t}.
}\end{align*}

\DIFadd{Since \(\X\tp{0} \deq \alt{X}\tp{0}\), it follows that \(\X\tp{\t} \deq \alt{X}\tp{\t}\) for all \(\t\in [0,\T]\). Given \(0\leq \tt < \t \leq \T\) and using the time-homogeneity of equation }\eqref{subsec::Well-:Eqn::SDE}\DIFadd{, we can write a similar expression proving that,
}

\begin{align*}
\DIFadd{\left(\X\pst{\sv\vsi{V}}\tp(\t),\X\pst{\sv\vsi{V}}\tp(\tt)\right) }&\DIFadd{= \left(\X\pst{\X\pst{\sv\vsi{V}}\tp{\tt}}\tp{\t-\tt},\X\pst{\sv\vsi{V}}\tp{\tt}\right)}\\
&\DIFadd{\deq \left(\alt{\X}\pst{\alt{\X}\pst{\sv\vsi{V}}\tp{\tt}}\tp{\t-\tt},\alt{\X}\pst{\sv\vsi{V}}\tp{\tt}\right)}\\
&\DIFadd{= \left(\alt{\X}\pst{\sv\vsi{V}}\tp{\t},\alt{\X}\pst{\sv\vsi{V}}\tp{\tt}\right).
}\end{align*}

\DIFadd{By iterating, conclude that the finite dimensional distributions of \(\X\) and \(\alt{\X}\) are equal in distribution. Since both processes have c\`adl\`ag sample paths, we can conclude that they are equal in distribution.
}
...
\DIFaddbegin \DIFadd{\usein Section \ref{sec::Proof2} in the proof of Theorem \ref{sec::Main:Thm::Local SDE}.
}

\DIFadd{\app Assumption \ref{subsec::Assum:Assu::CI}, Lemma \ref{sec::TL:Lem::Props} and all of section \ref{sec::Proof1}.
}
...
\DIFaddbegin \DIFadd{\usein At the moment, nothing. This is the main result. We may find some simulations or other examples with which to apply this Theorem.
}

\DIFadd{\app All of section \ref{sec::Proof2}, Assumption \ref{subsec::Assum:Assu::Local}, Proposition \ref{subsec::Well-:Prop::SDE=IG}, Lemma \ref{subsec::Well-:Lem::weaksoln}, Theorem \ref{sec::Main:Thm::CI}, Lemma \ref{subsec::Some:Lem::PPtoSDE}.
}
...
\DIFaddbegin \DIFadd{\usein All of section \ref{sec::Proof1}.
}
...
\DIFaddbegin \DIFadd{\usein Theorem \ref{sec::Main:Thm::CI}
}

\DIFadd{\app Lemma \ref{sec::TL:Lem::Props}, Lemma \ref{sec::Proof1:Lem::Decomposition}.
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{sec::Proof1:Lem::Induction}.
}

\DIFadd{\app Proposition \ref{subsec::Well-:Eqn::SDE}, Lemma \ref{subsec::Well-:Lem::SDEWP}.
}
...
\DIFaddbegin \DIFadd{\purpose This provides a convenient one-to-one mapping from jump processes to point processes. This allows me to use results from the theory point processes to prove the local approximation is well-defined.
}

\DIFadd{\usein All over the place in section \ref{sec::Proof2}. Lemma \ref{subsec::Some:Lem::PPtoSDE}.
}
...
\DIFaddbegin \DIFadd{\purpose This generalizes the left-continuous modification results slightly so that I can use the same proofs in Lemma \ref{subsec::ProofU:Lem::Marginal}.
}

\DIFadd{\usein Lemma \ref{subsec::ProofE:Lem::leftmod}, Lemma \ref{subsec::ProofE:Lem::pleft}, Lemma \ref{subsec::ProofE:Lem::bddvar} and Lemma \ref{subsec::ProofU:Lem::Marginal}.
}
...
\DIFaddbegin \DIFadd{\usein Theorem \ref{sec::Main:Thm::Local SDE}, Lemma \ref{subsec::ProofU:Lem::Marginal}.
}
...
\DIFadd{\app Assumption \ref{subsec::ProofE:Assu::Eassu}, Lemma \ref{subsec::ProofE:Lem::leftmodgen}, Lemma \ref{subsec::ProofE:Lem::pleft}, Lemma \ref{subsec::ProofE:Lem::bddvar}.
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::ProofE:Lem::leftmodgen}.
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::ProofE:Lem::leftmod}.
}

\DIFadd{\app Definition \ref{subsec::ProofE:Defn::elementary}.
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::ProofE:Lem::bddvar}, Theorem \ref{sec::Main:Thm::Local SDE}, Lemma \ref{subsec::ProofE:Lem::leftmod}.
}

\DIFadd{\app Assumption \ref{subsec::ProofE:Assu::Eassu}, Assumption \ref{subsec::Assum:Assu::Local}.
}
...
\DIFadd{\app Assumption \ref{subsec::Assum:Assu::Local}, Assumption \ref{subsec::ProofE:Assu::Eassu}, Lemma \ref{subsec::ProofE:Lem::pleft}.
}
...
Let \(\{\F\vsi{\tree\sln{1}}\ts{\t}:\t\in [0,\T]\}\) be the natural filtration of \(\X\cind{\tree\sln{1}}\). Recall that by Proposition \ref{subsec::Well-:Prop::SDE=IG}, \(\X\) can be expressed as the unique \DIFaddbegin \DIFadd{strong }\DIFaddend solution to,
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::ProofU:Lem::extendedSDE}
}

\DIFadd{\app Definition \ref{subsec::ProofE:Defn::pmap}, Lemma \ref{subsec::ProofE:Lem::pleft}, Lemma \ref{subsec::ProofE:Lem::filtering}, Lemma \ref{subsec::Some:Lem::genfiniteSDE}, Lemma \ref{subsec::Some:Lem::PPtoSDE}.
}
...
\DIFdelbegin \DIFdel{\tr{TODO::standardize space, time and mark orderings of Poisson processes.}
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \begin{defn}
...
\DIFaddbegin \DIFadd{\purpose This process works as a nice reference process compared to which the local approximation and its extensions (as designed in Lemma \ref{subsec::ProofU:Lem::extendedSDE}) are all absolutely continuous.
}

\DIFadd{\usein Lemma \ref{subsec::ProofU:Lem::extendedSDE}
}
...
\DIFaddbegin \DIFadd{\usein Theorem \ref{sec::Main:Thm::Local SDE}
}

\DIFadd{\app Definition \ref{subsec::ProofU:Defn::nu}, Lemma \ref{subsec::ProofU:Lem::Marginal}, Proposition \ref{subsec::Prope:Prop::radnikder}, Lemma \ref{subsec::Some:Lem::radnik}.
}
...
\DIFdelbegin \DIFdel{\ind \tr{(These are not functions anymore)} }\DIFdelend Let \(\v \in V\setminus\{\root\}\). Let \DIFdelbegin \DIFdel{\(\c:V\setminus\{\root\} \ra V^{\degr-1}\) be defined such that }\DIFdelend \(\c\vind{\v} = (\c\cind{1}\vind{\v},\dots,\c\cind{\degr-1}\vind{\v})\) \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{be }\DIFaddend the children of \(\v\). Let \DIFdelbegin \DIFdel{\(\p:V\setminus\{\root\}\ra V\) map nodes to their parent }\DIFdelend \DIFaddbegin \DIFadd{\(\p\vind{\v} \in V\) be the parent of \(\v\)}\DIFaddend .
...
Therefore the conditions of the Daniell-Kolmogorov extension theorem are satisfied \DIFaddbegin \DIFadd{(Lemma \ref{sec::TL:Lem::DanKolExt})}\DIFaddend . Therefore, there exists a \(\mmm\in \ms{P}(\sset\vsi{\U}\ts{\T-})\) such that \(\proj\vsi{\U}\ts{\T-}(\mmm) =\mmm\vind{\U}\) for all finite \(\U\).
\DIFdelbegin \DIFdel{\tr{citation needed (Reading off of Lecture notes (Theorem 2.4.3) which were used as the basis of Terence Tao's measure theory book)}.
}\DIFdelend 

\ind In particular, there exists a probability space with canonical process \(\X\) such that \(\mmm = \law(\X\tip{[0,\T)})\) and \(\mmm\vind{\v} = \law(\X\cind{\v}\tip{[0,\T)})\) for all \(\v \in V\). In particular, this means that \(\law(\X\cind{\tree\sln{n}}\tip{[0,\T)}) = \mmm\vind{\tree\sln{n}} = \mmm\sln{n}\). Since \(\X\cind{\tree\sln{n}} \ra \X\) almost surely (we are in the topology of componentwise convergence), \(\mmm\sln{n} \Rightarrow \mmm\). In order to characterize \(\X\) and \(\mmm\), we construct a stochastic differential equation on a probability space on which \(\X\sln{n} \sim \mmm\sln{n}\) and \(\X\sln{n} = \X\cind{\tree\sln{n}}\) almost surely. \DIFdelbegin \DIFdel{\tr{I don'\t know if it's clear, but we are taking \(\X\sln{n}\) and \(\X\) as given in this probability space.}
}\DIFdelend \DIFaddbegin \DIFadd{\tr{I don't know if it's clear, but we are taking \(\X\sln{n}\) and \(\X\) as given in this probability space.}
}\DIFaddend 

\ind On this space, we construct a sequence of i.i.d Poisson processes as follows (Construction is based on the proof of \cite[Theorem 14.7.1(b)]{DalVer08}. \DIFdelbegin \DIFdel{The result is given in \mbox{%DIFAUXCMD
\cite[Exercise 14.7.1]{DalVer08} }\hspace{0pt}%DIFAUXCMD
\tr{TODO: rigorously solve this exercise myself}}\DIFdelend \DIFaddbegin \DIFadd{See Lemma \ref{sec::TL:Lem::fatembedding}}\DIFaddend ).
...
\DIFdelbegin \[\DIFdel{\rate\sln{n}(\t,\sv\vsi{\tree\sln{n}}) = \begin{cases}
...
\DIFadd{\rate\sln{n}(\t,\sv\vsi{\tree\sln{n}}) = \begin{cases}
\rate(\X\sln{n}\cind{\cl{\v}}\tp{\t-},\s) &\te{ if } \sv\vsi{\tree\sln{n}} = \s\ev\vind{\v},\s \in \S\setminus\{0\},\v\in\tree\sln{n-1}\\
\crate(\X\sln{n}\cind{\{\v,\p\vind{\v}\}}\tip{[0,\t)},\s) &\te{ if } \sv\vsi{\tree\sln{n}} = \s\ev\vind{\v},\s\in\S\setminus\{0\},\v\in\tree\sln{n}\setminus\tree\sln{n-1}\\
0 &\te{ otherwise.}
\end{cases}
...
\DIFaddbegin \DIFadd{\labe{subsec::ProofU:eqn::pmaprate}
}\DIFaddend 

For any \(\evnt \in \ms{B}(\mb{R}^+\times\alt{\S}^n\times\mb{R}^+)\), define

\DIFdelbegin \begin{displaymath}
\DIFdel{\poiss\sln{n}(\evnt) = \alt{\poiss}\sln{n}\left(\evnt\cap\{(\t,\sv\vsi{\tree\sln{n}},\r):\r > \rate\sln{n}(\t,\sv\vsi{\tree\sln{n}})\}\right) + \#\{(\rt\slnvind{n}{\v}\indx{\it},\mark\indx{\it}\slnvind{n}{\v},\rv\vind{\v}\indx{\it}\rate\sln{n}(\rt\slnvind{n}{\v}\indx{\it},\mark\indx{\it}\slnvind{n}{\v}) \in \evnt: \v\in \tree\sln{n}\}.
%DIFDELCMD < \label{subsec::ProofU:eqn::Poissonexpl}%%%
}\end{displaymath}%DIFAUXCMD
\DIFdelend \DIFaddbegin \begin{align}
\DIFadd{\poiss\sln{n}(\evnt)}& \DIFadd{= \alt{\poiss}\sln{n}\left(\evnt\cap\{(\t,\sv\vsi{\tree\sln{n}},\r):\r > \rate\sln{n}(\t,\sv\vsi{\tree\sln{n}})\}\right)\nonumber}\\
&\DIFadd{\hspace{24 pt} + \#\{(\rt\slnvind{n}{\v}\indx{\it},\mark\indx{\it}\slnvind{n}{\v},\rv\vind{\v}\indx{\it}\rate\sln{n}(\rt\slnvind{n}{\v}\indx{\it},\mark\indx{\it}\slnvind{n}{\v}) \in \evnt: \v\in \tree\sln{n}\}.
\label{subsec::ProofU:eqn::Poissonexpl}
}\end{align}\DIFaddend 
\labe{subsec::ProofU:eqn::Poissonexpl}

Then \(\poiss\sln{n}\) is a Poisson random measure on \(\mb{R}^+\times\alt{\S}^n\times \mb{R}^+\) with intensity measure \(d\t\times \alt{\Sm}^n\times d\r\) (\DIFdelbegin \DIFdel{see proof of \mbox{%DIFAUXCMD
\cite[Theorem 14.7.1(b)]{DalVer08}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{Lemma \ref{sec::TL:Lem::fatembedding}}\DIFaddend )
...
\begin{lem}
The claims above are true. Namely, \(\poiss\sln{n}\) are all Poisson processes with intensity measure \(d\t\times\alt{\Sm^{n}}\times d\r\), \(\{\poiss\vind{\v}:\v\in V\}\) is a sequence of i.i.d. Poisson processes with intensity measure \(d\t\times\Sm\times d\r\) and \(\{\poiss\vind{\vv},\alt{\poiss}\vind{\vvv}:\vv\in \tree\sln{n-1},\vvv\in\tree\sln{n}\setminus\tree\sln{n-1}\}\) are i.i.d. for any \(n \in \mb{N}\). \DIFaddbegin \DIFadd{Finally, the joint distribution of \(\{\poiss\vind{\vv},\alt{\poiss}\vind{\vvv}:\vv\in \tree\sln{n-1},\vvv\in\tree\sln{n}\setminus\tree\sln{n-1}\}\) does not change when conditioned on \(\{\X\tp{0} = \sv\vsi{V}\}\) for any \(\sv\vsi{V}\in \S\carp{V}\).
}\DIFaddend 

\DIFaddbegin \DIFadd{\tr{TODO:: Include the construction above in the proof of this lemma. Lemma \ref{subsec::ProofU:Lem::Poisson} should follow directly after Lemma \ref{subsec::ProofU:Lem::extendedSDE}.}
}\DIFaddend \label{subsec::ProofU:Lem::Poisson}
\end{lem}
\labe{subsec::ProofU:Lem::Poisson}
\DIFaddbegin 

\DIFadd{\purpose This allows us to explicitly construct Poisson processes with which \(\mmm\) is a weak solution to equation }\eqref{subsec::Well-:Eqn::SDE}\DIFadd{.
}

\DIFadd{\pfsum Most of the work is done in the proof of Lemma \ref{sec::TL:Lem::fatembedding}. The idea is to find an embedded Poisson process so that \(\X\sln{n}\) solves equation }\eqref{subsec::ProofU:eqn::extendedSDE} \DIFadd{for all \(n\). Then overlap them and use independence properties of Poisson processes to show that the individual Poisson processes are i.i.d.
}

\DIFadd{\usein Theorem \ref{sec::Main:Thm::Local SDE}.
}

\DIFadd{\app Lemma \ref{sec::TL:Lem::fatembedding}, Lemma \ref{sec::TL:Lem::DanKolExt}, Definition \ref{subsec::ProofE:Defn::pmap}.
}\DIFaddend \begin{proof}

Fix \(n \in \mb{N}\). Notice that \DIFdelbegin \DIFdel{most }\DIFdelend \DIFaddbegin \DIFadd{all }\DIFaddend of the assumptions of \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite[Proposition 14.7.I(b)]{DalVer08} }\hspace{0pt}%DIFAUXCMD
are satisfied , except the filtration with respect to which \(\rate\sln{n}\) is predictable is slightly larger (the proposition requires the filtration to only contain the jumps of \(\X\sln{n}\), but not the initial state). However, the proof of the proposition does not fail when the initial state is included in the filtration (Lemma \ref{sec::TL:Lem::embedding}). Furthermore}\DIFdelend \DIFaddbegin \DIFadd{Lemma \ref{sec::TL:Lem::fatembedding} are satisfied by \(\rp\sln{n}\) and its intensity given in equation }\eqref{subsec::ProofU:eqn::pmaprate}\DIFadd{. Then, by Lemma \ref{sec::TL:Lem::fatembedding}}\DIFaddend , \(\poiss\sln{n}\) is \DIFdelbegin \DIFdel{the Poisson process constructed in the proof, so it is }\DIFdelend a Poisson process with intensity \(d\t\times \alt{\Sm^n}\times d\r\) \DIFaddbegin \DIFadd{even when conditioned on events of the form \(\{\X\tp{0} = \sv\vsi{V}\}\)}\DIFaddend .
...
\DIFdelbegin \DIFdel{However, by Propositions \ref{subsec::Well-:Prop::SDEWP} and \ref{subsec::Well-:Prop::SDE=IG}, equation }%DIFDELCMD < \eqref{subsec::ProofU:eqn::XSDE} %%%
\DIFdel{has a unique solution , and that solution }\DIFdelend \DIFaddbegin \DIFadd{\(\X\) is clearly adapted to the natural filtration of \(\{\poiss\vind{\v}\}\) augmented by \(\sigma(\X\tp{0})\). By Lemma \ref{subsec::ProofU:Lem::Poisson}, \(\{\poiss\vind{\v}\}\) remain i.i.d. unit intensity Poisson processes when conditioned on the initial state of \(\X\). Furthermore, \(\X\) is a weak solution to equation }\eqref{subsec::Well-:Eqn::SDE}\DIFadd{. By lemma \ref{subsec::Well-:Lem::weaksoln}, the law of \(\X\) coincides with the law of the unique strong solution to the equation. The unique strong solution }\DIFaddend has distribution \(\m\). Thus, \(\mmm = \m\). We conclude that \(\mmm\sln{1} = \proj\vsi{\tree\sln{1}}\ts{\T-}(\m)\).
...
\DIFaddbegin \DIFadd{\usein Proposition \ref{subsec::Well-:Prop::SDE=IG}.
}
...
\DIFaddbegin \begin{lem}
\DIFadd{Let \(\spce = \S\carp{V}\). Consider the following operator on \(\cont\):
}

\[\DIFadd{\IG f(\sv\vsi{V}) = \sum_{v \in V}\sum_{\s\in \S} \IGr\vind{\v}(\sv\vsi{V},\s)}[\DIFadd{f(\sv\vsi{V} + \s\ev\vind{\v}) - f(\sv\vsi{V})}]\DIFadd{, \sv\vsi{V} \in \S\carp{V}.}\]

\DIFadd{Then \(\IG\) is a well-defined infinitesimal generator of a Feller process if
}

\begin{itemize}
\item 

\[\DIFadd{\sup_{\v \in V,\sv\vsi{V} \in \S\carp{V}} \sum_{\s \in \S} \IGr\vind{\v}(\sv\vsi{V},\s) < \infty.}\]

\item 

\[\DIFadd{\sup_{\v\in V}\sum_{\vv\neq \v} \sup_{\substack{\sv\vsi{V} \in \S\carp{V}\\ \s\in \S\\ \SS \subseteq \S}} \left|\sum_{\ss \in \SS} (\IGr\vind{\v}(\sv\vsi{V},\ss) - \IGr\vind{\v}(\sv\vsi{V}+\s \ev\vind{\vv},\ss))\right| < \infty.}\]
\end{itemize}
\label{sec::Infin:Lem::IPS-IG}
\end{lem}
\DIFadd{\labe{sec::Infin:Lem::IPS-IG}
}

\DIFadd{\purpose This gives some simple inequalities that can be used to determine the well-posedness of a pure jump Feller process. 
}

\DIFadd{\usein Proposition \ref{subsec::Well-:Prop::Welldef}
}

\begin{proof}
\DIFadd{This is a special case of \mbox{%DIFAUXCMD
\cite[Chapter 1, Theorem 3.9]{Lig85}}\hspace{0pt}%DIFAUXCMD
.
}\end{proof}
\lin

\DIFaddend \begin{thms}[Trotter-Kurtz]
...
\DIFaddbegin \DIFadd{\usein Corollary \ref{sec::Infin:Cor::Convergence}.
}
...
\DIFaddbegin \DIFadd{\usein Proposition \ref{subsec::Well-:Prop::IGApprox}.
}

\DIFadd{\app Theorem \ref{sec::Infin:Thm::TrotterKurtz}.
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::Some:Lem::PPtoSDE}.
}
...
\DIFaddbegin \DIFadd{\purpose Might be used implicitly in some calculations involving intensity. \tr{TODO:: double check whether or not this is the case.}
}

\DIFadd{\usein Lemma \ref{Subsec::Prope:Lem::easy intense calc}.
}
...
\DIFaddbegin \DIFadd{\purpose I used this in earlier drafts, but I don't think I use it anymore. \tr{TODO:: Make sure I'm not implicitly using this result somewhere.}
}

\DIFadd{\app Lemma \ref{Subsec::Prope:Lem::easier}
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::ProofU:Lem::extendedSDE}, Lemma \ref{subsec::Some:Lem::radnik}.
}
...
\DIFaddbegin \DIFadd{\usein Lemma \ref{subsec::ProofU:Lem::Marginal}, Lemma \ref{subsec::Some:Lem::PPtoSDE}, Lemma \ref{subsec::Some:Lem::radnik}.
}
...
\DIFaddbegin \DIFadd{\purpose Allows us to skip directly from the point process representation of a process to the SDE representation. It is the reverse of Definition \ref{subsec::ProofE:Defn::pmap}.
}

\DIFadd{\pfsum Apply embedding theorems.
}

\DIFadd{\usein Lemma \ref{subsec::ProofU:Lem::Marginal}, Lemma \ref{subsec::Some:Lem::radnik}.
}

\DIFadd{\app Definition \ref{subsec::ProofE:Defn::pmap}, Lemma \ref{subsec::Some:Lem::genfiniteSDE}, Proposition \ref{subsec::Prope:Prop::intense char}.
}
...
\DIFadd{\app Proposition \ref{subsec::Prope:Prop::radnikder}, Lemma \ref{subsec::Some:Lem::genfiniteSDE}, Lemma \ref{subsec::Some:Lem::PPtoSDE}.
}
...
\DIFaddbegin \DIFadd{\purpose This gives several properties of conditional independence that allow us to indirectly prove our conditional independence result.
}

\DIFadd{\pfsum I use monotone class theorems and a functional representation of conditional independence.
}

\DIFadd{\usein Lemma \ref{subsec::Proof1:Lem::Induction}, Theorem \ref{sec::Main:Thm::CI}.
}
...
\begin{lem}
Let \DIFaddbegin \DIFadd{\(\ep >0\). Let }\DIFaddend \(\phi: \mb{R}^+ \ra \mb{R}^+\) be a monotonic function such that \(\phi(0+) = 0\). Suppose also that \(\phi \leq C\) for some constant \(C\). Then there exists a continuous monotonic concave function \(\psi:\mb{R}^+\ra \mb{R}^+\) such that \DIFdelbegin \DIFdel{\(\psi(0) = 0\) }\DIFdelend \DIFaddbegin \DIFadd{\(\psi(0) = \ep\) }\DIFaddend and \(\phi \leq \psi\leq C\).
...
\DIFaddbegin \DIFadd{\pfsum Use a simple piece-wise linear construction.
}

\DIFadd{\usein Proposition \ref{subsec::Well-:Prop::SDE=IG}
}



\DIFaddend \begin{proof}
\DIFdelbegin \DIFdel{Fix \(\ep > 0\).
}\DIFdelend Since \(\phi(0+) = 0\), there exists a \(\delta > 0\) such that \(\phi(\delta) < \ep/2\). Let \(\ov{\phi} = \min\{\phi+\ep/2, C\}\).

\ind Let \(a_\ep = \inf\{a \geq 0: a\x + \ep \geq \phi(\x)\te{ for all } \x\geq 0\}\). Note that \(0\leq a_\ep \leq C/\delta\). 

\ind Define \DIFdelbegin \DIFdel{\(\psi_\ep(\x) = \min\{a\x+\ep,C\}\). Then \(\psi_\ep\) }\DIFdelend \DIFaddbegin \DIFadd{\(\psi(\x) = \min\{a\x+\ep,C\}\). Then \(\psi\) }\DIFaddend is continuous, concave, non-decreasing, \(\psi_\ep(0) = \ep\) and \DIFdelbegin \DIFdel{\(\psi_\ep \geq \phi\).
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{\ind Let \(\psi(\x) = \inf_{\ep > 0} \psi_\ep(\x)\). Then \(\psi\) is trivially concave, bounded and non-decreasing. Furthermore, since it is non-decreasing, it can only have jump discontinuities, and left and right limits exist at each point. Suppose \(\x\) is a discontinuity point of \(\psi\). Let \(\triangle\psi(\x) = \psi(\x+) - \psi(\x-)\).
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{For any small \(\delta > 0\), notice that
}%DIFDELCMD < 

%DIFDELCMD < %%%
\[\DIFdel{\lim_{\delta \ra 0} \frac{\psi(\x-\delta) + \psi(\x+\delta)}{2} = \psi(\x-) + \frac{\triangle\psi(\x)}{2} > \psi(\x-).}\]%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Thus, there exists some \(\delta\) and some \(1>\rate>1/2\) such that
}%DIFDELCMD < 

%DIFDELCMD < %%%
\[\DIFdel{\rate\psi(\x-\delta) + (1 -\rate)\psi(\x+\delta) > \psi(\x-) > \psi(\x + (1 - 2\rate)\delta) = \psi\left(\rate(\x-\delta) + (1 - \rate)(\x+\delta)\right).}\]%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{This contradicts concavity of \(\psi\). Thus, \(\psi\) is continuous.
}\DIFdelend \DIFaddbegin \DIFadd{\(\psi \geq \phi\).
}\DIFaddend \end{proof}
...
\[\DIFdelbegin \DIFdel{\modu{\X}}\DIFdelend \DIFaddbegin \DIFadd{\modu\pra{\X}}\DIFaddend ([\t\indx{i-1},	{i})) = \sup_{\tt,\t\in [\t\indx{i-1},	{i})} d(\X\tp{\t},\X\tp{\tt}).\]
...
\DIFadd{\app Proposition \ref{subsec::Well-:Prop::SDE=IG}
}
...
\DIFaddbegin \begin{defn}
\DIFadd{Given a complete separable metric space \(\spce\), a dissecting system is a sequence of partitions \(\{\part\indcs{i}{n}:n \in \mb{N},i=1,\dots,k_n\}\) such that,
}

\begin{itemize}
\item \DIFadd{\(\{\part\indcs{i}{n}:i=1,\dots,k_n\}\) is a partition of \(\spce\) for all \(n\).
}

\item \DIFadd{For every \(m > n\), \(i \leq k_n\) and \(j \leq k_m\), \(\part\indcs{i}{n}\cap \part\indcs{j}{m} \in \{\emptyset, \part\indcs{j}{m}\}\).
}

\item \DIFadd{For every distinct pair \(\x,\xx \in \spce\), there exists an \(N < \infty\) so that for all \(n > N\), \(x \in \part\indcs{i}{n}\) and \(\xx \in \part\indcs{j}{n}\) implies that \(i \neq j\).
}\end{itemize}
\label{sec::TL:Def::DissectingSystem}
\end{defn}
\DIFadd{\labe{sec::TL:Def::DissectingSystem}}\\

\DIFadd{See \mbox{%DIFAUXCMD
\cite[Definition A1.6.I]{DalVer03}}\hspace{0pt}%DIFAUXCMD
.
}

\DIFadd{\purpose Needed for Definition \ref{sec::TL:Def::DissectingRing}.
}

\DIFadd{\usein Definition \ref{sec::TL:Def::DissectingRing}
}

\lin

\begin{defn}
\DIFadd{A dissecting ring is any ring generated by a dissecting system.
}\label{sec::TL:Def::DissectingRing}
\end{defn}
\DIFadd{\labe{sec::TL:Def::DissectingRing}}\\

\DIFadd{See \mbox{%DIFAUXCMD
\cite[Definition A2.1.V]{DalVer03}}\hspace{0pt}%DIFAUXCMD
.
}

\DIFadd{\purpose Necessary for Renyi-Monch theorem (Lemma \ref{sec::TL:Lem::Renyi-Monch}).
}

\DIFadd{\usein Lemma \ref{sec::TL:Lem::Renyi-Monch}
}

\DIFadd{\app Definition \ref{sec::TL:Def::DissectingSystem}
}

\lin

\DIFaddend \begin{lem}
\DIFdelbegin \DIFdel{We can apply \mbox{%DIFAUXCMD
\cite[Proposition 14.7.I(b)]{DalVer08} }\hspace{0pt}%DIFAUXCMD
to the proof of Lemma \ref{subsec::ProofU:Lem::Poisson} even though it does not satisfy all of the assumptions. }\DIFdelend \DIFaddbegin \DIFadd{The distribution of a simple point process \(\poiss\) on a complete separable metric space, \(\spce\), is determined by the values of the avoidance function \(P\gid{0}\defeq \pr(\poiss(\cdot) = 0)\) on the bounded sets of a dissecting ring of \(\spce\).
}\label{sec::TL:Lem::Renyi-Monch}
\end{lem}
\DIFadd{\labe{sec::TL:Lem::Renyi-Monch}
}

\DIFadd{\purpose This allows us to prove that the process constructed in section \ref{subsec::ProofU:sec::Proof2} is actually a Poisson process.
}

\DIFadd{\usein Lemma \ref{sec::TL:Lem::fatembedding}.
}

\DIFadd{\app Definition \ref{sec::TL:Def::DissectingRing}.
}

\begin{proof}
\DIFadd{This is just a restatement of \mbox{%DIFAUXCMD
\cite[Theorem 9.2.XII]{DalVer08}}\hspace{0pt}%DIFAUXCMD
.
}\end{proof}
\lin

\begin{lem}
\DIFadd{Let \(\poiss(\cdot,\cdot)\) be a marked point process on \(\mb{R}\times \mspce\) with natural history \(\FH\). Suppose \(\poiss\) has a \(\FH\)-predictable intensity \(\rate\). Then, extending the probability space if necessary, there exists a Poisson process \(\alt{\poiss}\) on \(\mb{R}_+\times \mspce\times \mb{R}_+\), with intensity measure \(d\t\times \ell(d\s)\times d\r\) (henceforth called unit intensity) such that \(\alt{\poiss}\) is \(\alt{\FH}\)-adapted and,
}

\[\DIFadd{\poiss(d\t\times d\s) = \alt{\poiss}\left(d\t\times d\s\times (0,\rate(\t,\s)]\right).}\]

\DIFadd{Moreover, \(\alt{\poiss}\) can be explicitly constructed as follows. Let \(\alt{\alt{\poiss}}\) be an Poisson process on \(\mb{R}\times \mspce\times \mb{R}_+\) with intensity measure \(d\t\times \Sm(d\s)\times d\r\) independent of \(\poiss\) and \(\alt{\poiss}\). Let \(\{\rv\indx{\it}\}\) be a sequence of i.i.d. uniform random variables supported on \([0,1]\). Then if \(\{(\rt\indx{\it},\mark\indx{\it})\}\) are the events of \(\poiss\), then for any \(\evnt \in\mc{B}(\mb{R}_+\times \mspce\times \mb{R}_+)\),
}

\begin{align}
\DIFadd{\alt{N}(\evnt) }&\DIFadd{\defeq \alt{\alt{N}}\left(\evnt \cap \{(\t,\s,\r): \r > \rate(\t,\s)\}\right) + \#\left\{\left(\rt\indx{\it},\mark\indx{\it},\rv\indx{\it}\rate(\rt\indx{\it},\mark\indx{\it})\right) \in \evnt\right\}
\label{sec::TL:eqn::embedding}
}\end{align}

\DIFadd{satisfies the conditions above.
}

\DIFaddend \label{sec::TL:Lem::embedding}
\end{lem}
\DIFaddbegin \DIFadd{\labe{sec::TL:Lem::embedding}
}

\DIFadd{\purpose This is the embedding theorem from Daley Vere Jones which lets us construct \(\X\) as the weak solution to an SDE.
}
...
\DIFaddend \begin{proof}
\DIFdelbegin \DIFdel{I }\DIFdelend \DIFaddbegin \DIFadd{The existence of \(\alt{\poiss}\) is given directly by \mbox{%DIFAUXCMD
\cite[Proposition 14.7.I(b)]{DalVer08} }\hspace{0pt}%DIFAUXCMD
(in fact, the proposition is holds for \(\poiss\) on \(\mb{R}\times \mspce \times \mb{R}_+\), which is stronger). Equation }\eqref{sec::TL:eqn::embedding} \DIFadd{is derived in the proof of the Proposition.
}\end{proof}

\lin

\begin{lem}
\DIFadd{Let us }\DIFaddend use the notation of \DIFdelbegin \DIFdel{section \ref{subsec::ProofU:sec::Proof2}. }\DIFdelend \DIFaddbegin \DIFadd{lemma \ref{sec::TL:Lem::embedding}. Suppose \(\mspce\) is finite. Let \(\F\ts{0} \defeq \sigma(\X)\) for some \(\mspce\)-valued random variable \(\X\), and let \(\F\ts{\t}\defeq \F\ts{0}\vee\FH\ts{\t}\). Then lemma \ref{sec::TL:Lem::embedding} holds if \(\poiss\) is assumed to be \(\F\)-adapted with \(\F\)-predictable intensity \(\rate\). Furthermore, for any \(\x\in \mspce\), \(\alt{\poiss}\) conditioned on \(\{\X = \x\}\) remains a unit intensity Poisson process.
}\label{sec::TL:Lem::fatembedding}
\end{lem}
\DIFadd{\labe{sec::TL:Lem::fatembedding}
}

\DIFadd{\purpose Extends the assumptions of Lemma \ref{sec::TL:Lem::embedding} to the case we are currently considering.
}

\DIFadd{\usein Lemma \ref{subsec::ProofU:Lem::Poisson}.
}

\DIFadd{\app Lemma \ref{sec::TL:Lem::Renyi-Monch}, Lemma \ref{sec::TL:Lem::embedding}.
}

\begin{proof}
\DIFaddend The assumptions of \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite[Proposition 14.7.I(b)]{DalVer08} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{lemma \ref{sec::TL:Lem::embedding} }\DIFaddend are as follows:

\begin{itemize}
\item \(\poiss(\cdot,\cdot)\) is a marked point process with internal history \(\FH\).

\item \(\poiss(\cdot,\cdot)\) has \(\FH\)-predictable intensity \DIFdelbegin \DIFdel{\(\rate(\t,\mark)\)}\DIFdelend \DIFaddbegin \DIFadd{\(\rate(\t,\s)\)}\DIFaddend .
\end{itemize}

\DIFdelbegin \DIFdel{If we let \(\poiss(\cdot,\cdot) = \pmap(\X\sln{n})\) (see Definition \ref{subsec::ProofE:Defn::pmap}), then the proof of \mbox{%DIFAUXCMD
\cite[Proposition 14.7.I(b)]{DalVer08} }\hspace{0pt}%DIFAUXCMD
shows thatthe point process defined in equation }%DIFDELCMD < \eqref{subsec::ProofU:eqn::Poissonexpl} %%%
\DIFdel{is a Poisson point process with intensity \(d\t\times \alt{\Sm^n}\times d\r\) and adapted to a larger filtration.
}\DIFdelend \DIFaddbegin \DIFadd{For any \(\x \in \mspce\), \(\{\x\} \in \F\ts{0}\). Let \(\{\rate\pst{\x}:\x \in \mspce\}\) be the unique family of functions such that,
}\DIFaddend 

\DIFdelbegin \DIFdel{\ind However, our intensity is actually only predictable with respect to \(\F \supseteq \FH\) which includes the value of \(\X\sln{n}\tp{0}\). This can be fixed simply. Let \(\rate\vindpst{\v}{\sv\vsi{\tree\sln{n}}}(\cdot,\cdot) \sim \law(\rate\vind{\v}(\cdot,\cdot)|\X\sln{n}\tp{0} = \sv\vsi{\tree\sln{n}})\). Then \(\rate\vindpst{\v}{\sv\vsi{\tree\sln{n}}}(\t,\mark)\) satisfies the conditions above. Then, }\DIFdelend \DIFaddbegin \[\DIFadd{\rate(\t,\s) = \sum_{\x \in \mspce} \mb{I}_{\X = \x}\rate\pst{\x}(\t,\s) \te{ for all } \t \in \mb{R}_+,\s \in \mspce.}\]
\DIFaddend 

\DIFaddbegin \DIFadd{Then for each fixed \(\x\in \mspce\), \(\rate\pst{\x}\) is \(\FH\)-predictable. For any \(\evnt \in \mc{B}(\mb{R}_+\times \mspce \times \mb{R}_+)\), Define,
}

\DIFaddend \[\DIFdelbegin \DIFdel{\poiss\sln{n}{\sv\vsi{\tree\sln{n}}}}\DIFdelend \DIFaddbegin \alt{\poiss}\DIFadd{\pst{\x}}\DIFaddend (\evnt) = \DIFdelbegin %DIFDELCMD < \alt{\poiss}%%%
\DIFdel{\sln{n}}\DIFdelend \DIFaddbegin \alt{\alt{\poiss}}\DIFaddend \left(\evnt\cap \{(\t,\DIFdelbegin %DIFDELCMD < \sv%%%
\DIFdel{\vsi{\tree\sln{n}}}\DIFdelend \DIFaddbegin \DIFadd{\s}\DIFaddend ,\r) : \r > \rate\DIFdelbegin \DIFdel{\slnpst{n}{\sv\vsi{\tree\sln{n}}}}\DIFdelend \DIFaddbegin \DIFadd{\pst{\x}}\DIFaddend (\t,\DIFdelbegin %DIFDELCMD < \sv%%%
\DIFdel{\vsi{\tree\sln{n}}}\DIFdelend \DIFaddbegin \DIFadd{\s}\DIFaddend )\}\right) + \#\{(\rt\DIFdelbegin \DIFdel{\slnvind{n}{\v}}\DIFdelend \indx{\it},\mark\indx{\it}\DIFdelbegin \DIFdel{\slnvind{n}{\v}}\DIFdelend ,\rv\DIFdelbegin \DIFdel{\vind{\v}}\DIFdelend \indx{\it}\rate\DIFdelbegin \DIFdel{\slnpst{n}{\sv\vsi{\tree\sln{n}}}}\DIFdelend \DIFaddbegin \DIFadd{\pst{\x}}\DIFaddend (\rt\DIFdelbegin \DIFdel{\slnvind{n}{\v}}\DIFdelend \indx{\it},\mark\indx{\it}\DIFdelbegin \DIFdel{\slnvind{n}{\v}}\DIFdelend )\DIFdelbegin \DIFdel{\in \evnt: \v\in \tree\sln{n}}\DIFdelend \}\DIFaddbegin \DIFadd{.}\DIFaddend \]

\DIFaddbegin \DIFadd{By lemma \ref{sec::TL:Lem::embedding}, \(\alt{\poiss}\pst{\x}\) }\DIFaddend is a Poisson process with \DIFdelbegin \DIFdel{intensity \(d\t\times \alt{\Sm^n}\times d\r\). Let \(R \subseteq \alt{\S}\carp{n}\),
and let }\DIFdelend \DIFaddbegin \DIFadd{unit intensity. Let \(\evnt \in \F\ts{0}\vee\ms{B}(\mb{R}_+\times \mspce\times \mb{R}_+)\). Let \(\evnt\pst{\x} = \evnt\cap \{\X = \x\}\) so we can consider \(\evnt\pst{\x}\) as an element in \(\ms{B}(\mb{R}_+\times \mspce\times \mb{R}_+)\). Then define,
}

\[\DIFadd{\alt{\poiss}(\evnt) \defeq \sum_{\x\in \mspce} \alt{\poiss}\pst{\x}(\evnt\pst{x}).}\]

\DIFadd{Let }\DIFaddend \(\inte\) and \(\alt{\inte}\) be intervals \DIFdelbegin \DIFdel{in \(\mb{R}^+\). Then,
}\DIFdelend \DIFaddbegin \DIFadd{of \(\mb{R}_+\). Let \(\SS \subseteq \mspce\)
}\DIFaddend 

\begin{align*}
\pr\left(\DIFdelbegin \DIFdel{\poiss\sln{n}}%DIFDELCMD < \left(%%%
\DIFdelend \DIFaddbegin \alt{\poiss}\DIFadd{(}\DIFaddend \inte\times \DIFdelbegin \DIFdel{R}\DIFdelend \DIFaddbegin \SS\DIFaddend \times \alt{\inte}\DIFdelbegin %DIFDELCMD < \right) %%%
\DIFdelend \DIFaddbegin \DIFadd{) }\DIFaddend = 0\right) &= \sum\DIFdelbegin \DIFdel{_{\sv\vsi{\tree\sln{n}} \in \alt{\S}^n} }\DIFdelend \DIFaddbegin \DIFadd{_{\x\in \mspce}}\DIFaddend \pr\left(\DIFdelbegin \DIFdel{\poiss\sln{n}{\sv\vsi{\tree\sln{n}}}}%DIFDELCMD < \left(%%%
\DIFdelend \DIFaddbegin \alt{\poiss}\DIFadd{\pst{\x}(}\DIFaddend \inte\times \DIFdelbegin \DIFdel{R}\DIFdelend \DIFaddbegin \SS\DIFaddend \times \alt{\inte}\DIFdelbegin %DIFDELCMD < \right) %%%
\DIFdelend \DIFaddbegin \DIFadd{) }\DIFaddend = 0\right)\pr(\X \DIFdelbegin \DIFdel{\sln{n}\tp{0} }\DIFdelend = \DIFdelbegin %DIFDELCMD < \sv%%%
\DIFdel{\vsi{\tree\sln{n}}}\DIFdelend \DIFaddbegin \DIFadd{\x}\DIFaddend )\\
&\DIFdelbegin \DIFdel{= }\DIFdelend \DIFaddbegin \os{\alt{\poiss}\pst{\x}\te{ unit Poisson}}{=} \DIFaddend \exp\left(-|\DIFdelbegin \DIFdel{R| |}\DIFdelend \inte||\alt{\inte}|\DIFaddbegin \DIFadd{\Sm(}\SS\DIFadd{)}\DIFaddend \right)\sum\DIFdelbegin \DIFdel{_{\sv\vsi{\tree\sln{n}} \in \alt{\S}\carp{n}} }\DIFdelend \DIFaddbegin \DIFadd{_{\x\in \mspce}}\DIFaddend \pr(\X \DIFdelbegin \DIFdel{\sln{n}\tp{0} }\DIFdelend = \DIFdelbegin %DIFDELCMD < \sv%%%
\DIFdel{\vsi{\tree\sln{n}}}\DIFdelend \DIFaddbegin \DIFadd{\x}\DIFaddend )\\
&= \exp\left(-|\DIFdelbegin \DIFdel{R| |}\DIFdelend \inte||\alt{\inte}|\DIFaddbegin \DIFadd{\Sm(}\SS\DIFadd{)}\DIFaddend \right)
\end{align*}

Since this holds for every rectangle, \DIFdelbegin \DIFdel{\(\poiss\sln{n}\) }\DIFdelend \DIFaddbegin \DIFadd{and since the rectangles form a dissecting ring on \([0,\T]\times \mspce \times [0,\const]\) for every \(\T,\const < \infty\), \(\alt{\poiss}\) }\DIFaddend is a Poisson process on \DIFdelbegin \DIFdel{\([0,T]\times \alt{\S}\carp{n}\times [0,\const]\) by R\'enyi,
M\"onch \mbox{%DIFAUXCMD
\cite[Theorem 9.2.XII]{DalVer08}}\hspace{0pt}%DIFAUXCMD
.
}\DIFdelend \DIFaddbegin \DIFadd{\([0,\T]\times \mspce \times [0,\const]\) with unit intensity (Lemma \ref{sec::TL:Lem::Renyi-Monch}). Since this is true for arbitrary \(\T,\const < \infty\), \(\alt{\poiss}\) is a Poisson process on \(\mb{R}_+ \times \mspce \times \mb{R}_+\) with unit intensity.
}\end{proof}
\DIFaddend 

\DIFaddbegin \lin
\begin{lem}[Danielle-Kolmogorov Extension Theorem]
\DIFadd{Let \(((\spce\indx{\alpha},\F\indx{\alpha}),\topo\indx{\alpha})\indxset{A}\) be a family of measurable spaces \((\spce\indx{\alpha},\F\indx{\alpha})\) equipped with a topology \(\topo\indx{\alpha}\). For each finite \(B \subset A\), let \(\m\indxset{B}\) be an inner regular probability measure on \(\F\indxset{B} \defeq \prod_{\alpha\in B} \F\indx{\alpha}\), obeying the following compatibility condition for all finite \(B\) and \(C\) such that \(C \subset B\subset A\):
}

\begin{itemize}
\item \DIFadd{\(\proj\indxset{B}: \spce\indxset{A} \ra \spce\indxset{A}\) is defined by \(\proj\indxset{B}\left((\x\indx{\alpha})\indxset{\alpha\in A}\right) = (\x\indx{\alpha})\indxset{\alpha\in B}\).
}

\item \DIFadd{\(\proj\indxset{C\leftarrow B}\left((\x\indx{\alpha})\indxset{\alpha \in B}\right) = (\x\indx{\alpha})\indxset{\alpha \in C}\).
}

\item \DIFadd{For all events \(\evnt\indxset{C} \in \F\indxset{C}\),
}

\[\DIFadd{\m\indxset{C}(\evnt\indxset{C}) = \m\indxset{B}\left(\proj\indxset{C\leftarrow B}^{-1}(\evnt\indxset{C})\right).}\]
\end{itemize}

\DIFadd{Then there exists a unique probability measure \(\m\indxset{A}\) on \(\F\indxset{A}\) such that \(\m\indxset{B}(\cdot) = \m\indxset{A}\left(\proj\indxset{B}^{-1}(\cdot)\right)\) for all finite \(B \subset A\).
}\label{sec::TL:Lem::DanKolExt}
\end{lem}
\DIFadd{\labe{sec::TL:Lem::DanKolExt}
}

\DIFadd{\purpose By continually extending \(\m\sln{1}\) to larger and larger measures, this theorem guarantees the existence of a unique measure on infinite-dimensional space that has \(\m\sln{1}\) as a marginal.
}
...
\begin{proof}
\DIFadd{This is a restatement of Theorem 62 from }\url{https://terrytao.wordpress.com/2010/10/30/245a-notes-6-outer-measures-pre-measures-and-product-measures/#more-4371}\DIFadd{. \tr{TODO:: find a better source.}
}\DIFaddend \end{proof}
\newpage
